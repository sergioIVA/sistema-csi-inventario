	...
	<?php
		...
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10" >
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Registrar Centro de Cableado</h4>
                   ...
                   while($row = $result->fetch_assoc()) {
					...
					<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Centro Cableado</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" id="nombre" name="nombre1" placeholder="ejemplo salon/oficina ">
							</div>
						</div>
				</div>
						<div class="pd-20 bg-white border-radius-4 box-shadow text-center height-100-p">
							...
							<button type="button"  onclick="registrarCentros(document.getElementById('ubicaciones').options[ubicaciones.selectedIndex].value,document.getElementById('nombre').value)" class="btn mb-20 btn-outline-primary" id="ssa-custom-agregarUbicacion">Registrar</button>
