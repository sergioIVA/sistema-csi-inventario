	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="modulo_csi.php">
				<img src="vendors/images/csi1.jpg" alt="">
			</a>
		</div>
				...
				<ul id="accordion-menu">
				     <li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-desktop"></span><span class="mtext">Equipos</span>
						</a>
						<ul class="submenu">
							<li><a  onclick="mostrarEquipos()" >Mostrar Equipos</a></li>
						</ul>
					</li>
					 <li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-calendar"></span><span class="mtext">Mantenimientos</span>
						</a>
						<ul class="submenu">
						    <li><a  onclick="equiposMantenimiento()" >Mantenimientos de Equipos</a></li>
							<li><a  href="historialMantenimiento.php" >Historial Mantenimientos</a></li>
						</ul>
					</li>
				<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-building"></span><span class="mtext">Edificios</span>
						</a>
						<ul class="submenu">
							<li><a onclick="mostrarEdificios()">Mostrar Edificios</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-building-o"></span><span class="mtext">Pisos</span>
						</a>
						<ul class="submenu">
							<li><a onclick="mostrarUbicaciones()">Mostrar Pisos</a></li>
							
						</ul>
					</li>
				   	<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-bars"></span><span class="mtext">Centro de cableados</span>
						</a>
						<ul class="submenu">
							<li><a onclick="mostrarCentrosCableado()">Mostrar Centros</a></li>
							
						</ul>
					</li>
				<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="fa fa-television"></span><span class="mtext">Tipo de Dispositivos</span>
						</a>
						<ul class="submenu">
							<li><a onclick="mostrarTipoDispositivo()">Tipos</a></li>
						</ul>
					</li>
